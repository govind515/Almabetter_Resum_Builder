...
// Define Template1 component
const Template1 = (props) => {
  // Destructuring props or fallback to default data
    ...
    >
      ...
      <Container>
        ...
        <ul style={{ marginBottom: 10 }}>
          {/* Mapping over work experience data */}
