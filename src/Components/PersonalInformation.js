...
// Styled Bootstrap Dialog component using MUI's styled API
...
// PersonalInfoComponent functional component
const PersonalInfoComponent = (props) => {
  ...
  // Function to handle cropping image
  const onCrop = (view) => {
    setImg(view);
  };

  // Function to handle closing image editor
  const onClose = (view) => {
    setImg(null);
  };
...
// Exporting the PersonalInfoComponent with Redux connection
